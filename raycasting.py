...
class RayCasting:
    def __init__(self,game):
        ...
        self.texture = self.game.object_rendrer.wall_testure
    ...
    def get_object_to_renderer(self):
        ...
        for ray,value in enumerate(self.ray_casting_result):
            ...
            if proj_height < HEIGHT:
                ...
                wall_column = self.texture[texture].subsurface(offset *(TEXTURE_SIZE - SCALE), HALF_TEXTURE_SIZE - texture_height // 2, SCALE, texture_height)
